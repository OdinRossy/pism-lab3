...
<html lang="ru">
    <head>
        ...
        <title>Опрос пользователя <%=jspHandler.getUsername()%></title>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
        <link rel="stylesheet" href="../../pism-lab3/style/main.css">
    ...
    <body>
        <div class="container-fluent">
            <div class="row row-center">
                ...
                <div class="col-md-10 rounded-container">
                    <h2>Здравствуйте, <span class="badge badge-success"><%=jspHandler.getUsername()%></span></h2>
        ...
        <script src="../../pism-lab3/script/main.js"></script>
    </body>
</html>